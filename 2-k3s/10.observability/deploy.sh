...
echo "     Loop every replica when reading Alertmanager state - the ruler talks to all three and gossip does not replicate the alert set (#1053):"
echo "     for i in 0 1 2; do kubectl exec -n observability alertmanager-kube-prometheus-stack-alertmanager-\$i -c alertmanager -- amtool alert query; done"
echo ""
